    ...
    <section className="mt-12 p-10 flex flex-col md:flex-row items-center gap-8 bg-gray-900">
      ...
      <div>
        ...
        <p className="text-gray-200 mb-4 max-w 4xl">
          I'm Karan, a passionate and experienced Full Stack Developer with a
          strong focus on creating dynamic and user-friendly web applications. I
          specialize in the MERN stack (MongoDB, Express.js, React, Node.js) and
